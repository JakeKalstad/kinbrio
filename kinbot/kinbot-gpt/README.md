...
Thanks to llama-cpp-python, a drop-in replacement for OpenAI API is available at `http://localhost:3002`. Open http://localhost:3002/docs to see the API documentation.
